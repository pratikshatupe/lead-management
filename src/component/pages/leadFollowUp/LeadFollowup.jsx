        ...
        <tbody>
          {data.map((item) => (
            <tr key={item.id} className="border-b">
              ...
              <td className="p-3">{item.follow}</td>
              <td className="p-3">
      ...
      {data.map((item) => (
        ...
        >
          <div className="flex justify-between mb-2">
            ...
            <span className="text-blue-500">{item.ref}</span>
          </div>
          <div className="flex justify-between mb-2">
          ...
          <div className="flex justify-between mb-2">
            <span className="text-gray-500">Follow Time</span>
            <span>{item.time}</span>
          </div>
          <div className="flex justify-between mb-3">
            <span className="text-gray-500">Follow By</span>
            <span>{item.follow}</span>
          </div>

          {/* ✅ Updated: w-9 h-9 icon-only buttons */}
          <div className="flex gap-2">
            <button
              onClick={() => setShowPopup(true)}
              className="w-9 h-9 flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors shadow-sm"
