...
import {
  FaHome, FaUserTie, FaUserPlus, FaHeadset,
  FaBullhorn, FaCalendarCheck, FaEnvelope,
  FaWpforms, FaCog, FaSignOutAlt,
  FaChevronDown, FaChevronRight, FaTimes, FaListAlt
} from "react-icons/fa";
...
const menuItems = [
  ...
  {
    label: "Salesmans", icon: <FaUserTie />,
    children: [
  ...
  {
    label: "Lead Management", icon: <FaUserPlus />,
    children: [
...
export default function ManagerSidebar({ sidebarOpen, setSidebarOpen, collapsed }) {
